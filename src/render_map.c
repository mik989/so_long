...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/17 21:05:50 by mgirardi          #+#    #+#             */
/*   Updated: 2023/01/17 21:05:57 by mgirardi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_map_render_logic(t_mlx *init, t_tile **tile_map, int x, int y)
{
	...
	{
		ft_print_and_destroy(init, "sprites/kingo/kingo_0.xpm", x, y);
		init->kingo.x = x;
		init->kingo.y = y;
	}
	else if (tile_map[y][x].type == 'E')
	{
		...
		ft_print_and_destroy(init, "sprites/col/key.xpm", x, y);
}
